...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
	    ...
	    Route::group(['prefix' => 'vendor'],function(){
			Route::get('/list','Admin\VendorController@index')->name('admin.vendor.list');
			Route::get('/create','Admin\VendorController@create')->name('admin.vendor.create');
			Route::post('/store','Admin\VendorController@store')->name('admin.vendor.store');
			Route::get('{vendorId}/edit','Admin\VendorController@edit')->name('admin.vendor.edit');
			Route::post('{vendorId}/update','Admin\VendorController@update')->name('admin.vendor.update');
			Route::get('{vendorId}/delete','Admin\VendorController@delete')->name('admin.vendor.delete');
			Route::get('/import', 'Admin\VendorController@import')->name('admin.vendor.import');
			Route::post('/import', 'Admin\VendorController@csvUpload')->name('admin.vendor.importsave');
	    });
		...
		Route::group(['prefix'  =>   'categories'], function() {
			...
			Route::get('/import', 'Admin\CategoryController@import')->name('admin.categories.import');
			Route::post('/import', 'Admin\CategoryController@csvUpload')->name('admin.categories.importsave');
		});
		...
		Route::group(['prefix'  =>   'products'], function() {
			...
			Route::get('/import', 'Admin\ProductsController@import')->name('admin.products.import');
			Route::post('/import', 'Admin\ProductsController@importProduct')->name('admin.products.importsave');
			Route::get('/upload_images', 'Admin\ProductsController@upload_images')->name('admin.products.upload_images');
		});
		Route::group(['prefix'  =>   'brands'], function() {
			...
			Route::get('/import', 'Admin\BrandController@import')->name('admin.brand.import');
			Route::post('/import', 'Admin\BrandController@brandUpload')->name('admin.brand.importsave');
		});
		...
		Route::group(['prefix'  => 'couponcodes'], function() {
			...
			Route::get('/import', 'Admin\CouponCodeController@import')->name('admin.couponcode.import');
			Route::post('/import', 'Admin\CouponCodeController@csvUpload')->name('admin.couponcode.importsave');
		});
		...
		Route::group(['prefix'  =>   'users'], function() {
			...
			Route::get('/delivery_boys', 'Admin\UserManagementController@delivery_boys')->name('admin.users.delivery_boys');
		});
		...
		Route::group(['prefix'  =>   'orders'], function() {
			...
			Route::get('/date-wise-report', 'Admin\OrderController@date_wise_report')->name('admin.orders.date_wise_report');
			Route::get('/today-sales', 'Admin\OrderController@today_sales')->name('admin.orders.today_sales');
			Route::get('/transaction-list', 'Admin\OrderController@transaction_list')->name('admin.orders.transaction_list');
		});

		Route::group(['prefix'  =>   'godown'], function() {
			Route::get('/', 'Admin\GodownController@index')->name('admin.godown.index');
			Route::get('/create', 'Admin\GodownController@create')->name('admin.godown.create');
			Route::post('/store', 'Admin\GodownController@store')->name('admin.godown.store');
			Route::get('/{id}/edit', 'Admin\GodownController@edit')->name('admin.godown.edit');
			Route::post('/update', 'Admin\GodownController@update')->name('admin.godown.update');
			Route::get('/{id}/delete', 'Admin\GodownController@delete')->name('admin.godown.delete');
			Route::post('updateStatus', 'Admin\GodownController@updateStatus')->name('admin.godown.updateStatus');
		});
	});
