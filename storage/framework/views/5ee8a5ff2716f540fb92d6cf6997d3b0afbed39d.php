     ...
     $('.btn-base-1').on('click',function(){
      ...
      console.log('amountinpaisa>>'+amount);
       ...
       options = {
           ...
           "description": "Payment for Mashroo",

           "image": "<?php echo e(asset('frontend/img/logo.png')); ?>",
...
<?php echo $__env->make('site.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo9dtx/public_html/dev/dazzle/resources/views/site/products/payment.blade.php ENDPATH**/ ?>