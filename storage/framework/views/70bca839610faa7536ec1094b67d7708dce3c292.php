    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="<?php echo e(route('admin.couponcode.update')); ?>" method="POST" role="form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" value="<?php echo e($couponCode->id); ?>" >
                    <div class="tile-body">
...
unset($__errorArgs, $__bag); ?>" type="text" name="coupon_name" id="coupon_name" value="<?php echo e($couponCode->coupon_name); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="coupon_code" id="coupon_code" value="<?php echo e($couponCode->coupon_code); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="date" name="start_date" id="start_date" value="<?php echo e($couponCode->start_date); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="date" name="end_date" id="end_date" value="<?php echo e($couponCode->end_date); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="offer_rate" id="offer_rate" value="<?php echo e($couponCode->offer_rate); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="maximum_time_of_use" id="maximum_time_of_use" value="<?php echo e($couponCode->maximum_time_of_use); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="maximum_user_can_use" id="maximum_user_can_use" value="<?php echo e($couponCode->maximum_user_can_use); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" class="grey" name="offer_type" value="1"<?php if($couponCode->offer_type==1): ?><?php echo e('checked'); ?> <?php endif; ?>>
                            Fixed Amount
                            </label>
                            <label class="radio-inline">
                            <input type="radio" class="grey" name="offer_type" value="2"<?php if($couponCode->offer_type==2): ?><?php echo e('checked'); ?> <?php endif; ?>>
                            Offer In Percentage
                            </label>
                        </div>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo9dtx/public_html/dev/dazzle/resources/views/admin/couponcode/edit.blade.php ENDPATH**/ ?>