...
unset($__errorArgs, $__bag); ?>" type="text" name="usprice" id="usprice" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('usprice',$targetproduct->usprice)); ?>" required/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="usoffered_price" id="usoffered_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('usoffered_price',$targetproduct->usoffered_price)); ?>" required/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="uscurrency" id="uscurrency" value="<?php echo e(old('uscurrency',$targetproduct->uscurrency)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="usshipping_charge" id="usshipping_charge" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('usshipping_charge',$targetproduct->usshipping_charge)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="usmeta_title" id="usmeta_title" value="<?php echo e(old('usmeta_title',$targetproduct->usmeta_title)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="usmeta_keywords" id="usmeta_keywords" value="<?php echo e(old('usmeta_keywords',$targetproduct->usmeta_keywords)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="usimg_alt_tag" id="usimg_alt_tag" value="<?php echo e(old('usimg_alt_tag',$targetproduct->usimg_alt_tag)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" rows="8"><?php echo e($targetproduct->usmeta_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukprice" id="ukprice" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('ukprice',$targetproduct->ukprice)); ?>" required/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukoffered_price" id="ukoffered_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('ukoffered_price',$targetproduct->ukoffered_price)); ?>" required/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukcurrency" id="ukcurrency" value="<?php echo e(old('ukcurrency',$targetproduct->ukcurrency)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukshipping_charge" id="ukshipping_charge" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('ukshipping_charge',$targetproduct->ukshipping_charge)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukmeta_title" id="ukmeta_title" value="<?php echo e(old('ukmeta_title',$targetproduct->ukmeta_title)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukmeta_keywords" id="ukmeta_keywords" value="<?php echo e(old('ukmeta_keywords',$targetproduct->ukmeta_keywords)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="ukimg_alt_tag" id="ukimg_alt_tag" value="<?php echo e(old('ukimg_alt_tag',$targetproduct->ukimg_alt_tag)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" rows="8"><?php echo e($targetproduct->ukmeta_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowprice" id="rowprice" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('rowprice',$targetproduct->rowprice)); ?>" required/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowoffered_price" id="rowoffered_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('rowoffered_price',$targetproduct->rowoffered_price)); ?>" required/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowcurrency" id="rowcurrency" value="<?php echo e(old('rowcurrency',$targetproduct->rowcurrency)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowshipping_charge" id="rowshipping_charge" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('rowshipping_charge',$targetproduct->rowshipping_charge)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowmeta_title" id="rowmeta_title" value="<?php echo e(old('rowmeta_title',$targetproduct->rowmeta_title)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowmeta_keywords" id="rowmeta_keywords" value="<?php echo e(old('rowmeta_keywords',$targetproduct->rowmeta_keywords)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" type="text" name="rowimg_alt_tag" id="rowimg_alt_tag" value="<?php echo e(old('rowimg_alt_tag',$targetproduct->rowimg_alt_tag)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" rows="8"><?php echo e($targetproduct->rowmeta_description); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo9dtx/public_html/dev/utkarsh/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>