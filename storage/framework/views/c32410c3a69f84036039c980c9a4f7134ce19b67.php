                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <a href="<?php echo e(route('admin.products.stock', ['id' => $products->id, 'idd'=>'1'])); ?>" class="btn btn-sm btn-primary">Out Of Stock</a>
                                            ...
                                            <a href="<?php echo e(route('admin.products.detail', $products->id)); ?>" class="btn btn-sm btn-primary"><i class="fa fa-map-pin"></i></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\utkarsh\resources\views/admin/product/index.blade.php ENDPATH**/ ?>