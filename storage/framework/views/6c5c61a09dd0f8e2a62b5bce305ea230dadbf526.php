...
<div class="row invoice" id="print_div" style="margin-top:20px;">
        <div class="col-sm-12">
            <div class="col-sm-6">
                <div class="logo"><img src="<?php echo e(asset('/frontend/img/icon/logo.png')); ?>" style="width:200px;margin-bottom:20px;">
                <span style="display:block;font-size:20px;font-weight:500;margin-top:-25px;margin-left:82px;">Mashroo Store Modest Clothing</span>
                </div>
            </div>
            ...
            <table class="table details">
                <tr>
                    <td style="border: none;">
                        ...
                        <p style="margin: 0;">Mashroo<br/>29, Blue Flame Apts,<br/>Opp. Bandra Jama Masjid,</br> Bandra West,</br> Mumbai 400 050, Maharashtra.</p>
                    </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo9dtx/public_html/dev/dazzle/resources/views/admin/order/invoice.blade.php ENDPATH**/ ?>