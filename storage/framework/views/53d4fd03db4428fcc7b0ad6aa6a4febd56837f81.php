                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group has-feedback">
                           ...
                           <input type="text" min="0" class="form-control" placeholder="Landmark" id="shipping_landmark" name="shipping_landmark" required>
                        </div>
                     </div>
                  </div>
...
<script>
   ...
   function initialize(){
      var autocomplete= new google.maps.places.Autocomplete(document.getElementById('shipping_landmark'));
      ...
      google.maps.event.addListener(autocomplete, 'place_changed', function(){
         ...
         console.log(places);
         var adressComponent = places.address_components;
         $('#shipping_landmark').val(places.formatted_address);
