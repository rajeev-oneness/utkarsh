...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="<?php echo e(route('admin.productstock.update')); ?>" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="product_id" id="product_id">
                                ...
                                <option value="<?php echo e($n->id); ?>"<?php if($n->id== $targetProduct->product_id): ?><?php echo e('selected'); ?> <?php endif; ?>><?php echo e($n->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- <div class="form-group">
                            <label class="control-label" for="name">Select Size<span class="m-l-5 text-danger"> *</span></label>
...
unset($__errorArgs, $__bag); ?>" name="size_id" id="">
                            ...
                            <option value="<?php echo e($n->id); ?>"<?php if($n->id == $targetProduct->size_id): ?><?php echo e('selected'); ?> <?php endif; ?>><?php echo e($n->sizes); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="current_stock" id="current_stock" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e($targetProduct->current_stock); ?>" />
...
unset($__errorArgs, $__bag); ?>" type="text" name="stock_alert" id="stock_alert" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e($targetProduct->stock_alert); ?>" />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/demo9tbi/utkarshelectricals.in/resources/views/admin/productstock/edit.blade.php ENDPATH**/ ?>