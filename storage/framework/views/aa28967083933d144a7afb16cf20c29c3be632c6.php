    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="<?php echo e(route('admin.banner.store')); ?>" method="POST" role="form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="tile-body">
...
unset($__errorArgs, $__bag); ?>" type="text" name="link" id="link" value="<?php echo e(old('link')); ?>"/>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/demo9tbi/utkarshelectricals.in/resources/views/admin/banner/create.blade.php ENDPATH**/ ?>