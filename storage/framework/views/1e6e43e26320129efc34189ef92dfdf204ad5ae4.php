...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="<?php echo e(route('admin.brand.importsave')); ?>" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn btn-secondary" href="<?php echo e(route('admin.brand.index')); ?>"><i style="vertical-align: baseline;" class="fa fa-chevron-left"></i>Back</a>
                    </div>

                    <p><a href="<?php echo e(asset('/csv/brand.csv')); ?>" target="_blank">Download Sample File Here</a></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\utkarsh\resources\views/admin/brand/import.blade.php ENDPATH**/ ?>