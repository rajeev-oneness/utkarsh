         ...
         <div class="col-xl-10 offset-xl-1">
            <div class="card">
               ...
               <div class="px-5 py-3 py-lg-5">
                  <div class="row align-items-center">					<div class="col-12 col-sm-6 left-pic text-center">	             <img src="<?php echo e(asset('frontend/img/undraw_Login_re_4vu2.png')); ?>" class="img-fluid" alt="">                    </div>					<div class="col-lg-1 text-center align-self-stretch">                        <div class="border-right h-100 mx-auto" style="width:1px;"></div>                     </div>
...
<?php echo $__env->make('site.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demo9dtx/public_html/dev/utkarsh/resources/views/site/auth/registration.blade.php ENDPATH**/ ?>