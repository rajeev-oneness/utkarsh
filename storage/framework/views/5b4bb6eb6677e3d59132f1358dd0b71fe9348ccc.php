<div class="tile">
    <form action="<?php echo e(route('admin.profile.changepassword')); ?>" method="POST" role="form" id="formpassword">
        <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/kaboi2pm1r04/public_html/utkarshelectricals.in/resources/views/admin/profile/includes/password.blade.php ENDPATH**/ ?>