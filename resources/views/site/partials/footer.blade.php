		...
		<div class="row m-0">
			<div class="col-md-3 col-12">
				<div class="footer-widget">
					<!--<a href="" class="d-block mb-3">
						<img src="{{ asset('frontend/img/logo.png') }}" alt="Mashroo Store" class="" height="44">
                     </a>-->
			...
			<div class="col-md-2 col-6 p-0 pl-md-5 offset-0 offset-md-1">
				<div class="footer-widget">
					...
					<ul class="footer-menu">
						<li><a href="{{ route('site.login') }}" title="Login">Login</a></li>
						<li><a href="" title="Order History">Order History</a></li>
						<li><a href="{{ route('site.wishlist') }}" title="My Wishlist">My Wishlist</a></li>
						<li><a href="" title="Track Order">Track Order</a></li>
						<!--<li><a href="{{ route('site.ourcustomers') }}" title="Our Customers">MASHROO CLAN</a></li>-->
					</ul>
				</div>
			</div>
			...
			<div class="col-md-4 col-12 p-0 pl-md-2">
				<div class="footer-widget">
					...
					<form class="form-inline d-flex" method="post" action="{{ route('site.newsletter.save') }}">
						@csrf
			...
			<div class="col-12 col-md-12 p-0 pt-4 mt-5 border-top ft_bottom_text row m-0">
				...
				<div class="col-12 col-md-6 text-right">
					<img src="{{ asset('frontend/img/cards/rozarpay.png') }}" height="20" alt="Rozarpay">
					<img src="{{ asset('frontend/img/cards/cod.png') }}" height="20" alt="COD">
				</div>
			</div>
		</div>
	</div>
               ...
               <div class="col-lg-5 col-xl-4 text-center text-md-left">
                  ...
                  <div class="col">
                     ...
                     <div class="d-inline-block d-md-block">
                        ...
                        <form class="form-inline" method="post" action="{{ route('site.newsletter.save') }}">
                  ...
                  <div class="col text-center text-md-left">
                     ...
                     <ul class="footer-links">
                        ...
                        <li>
                           ...
                           <a href="{{ route('site.login') }}" title="Login">
                        ...
                        <li>
                           ...
                           <a href="{{ route('site.wishlist') }}" title="My Wishlist">
                        ...
                        <li>
                           ...
                           <a href="{{ route('site.ourcustomers') }}" title="Our Customers">
