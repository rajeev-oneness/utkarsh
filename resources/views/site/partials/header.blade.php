...
<html>
   <head>
	  ...
	  <link  href="{{ asset('frontend/css/themify-icons.css') }}" type="text/css" rel="stylesheet">
	  ...
	  <link  href="{{ asset('frontend/css/style_new.css') }}" type="text/css" rel="stylesheet">
      ...
      <link  href="{{ asset('frontend/css/nav.css') }}" type="text/css" rel="stylesheet">
					...
					<div class="row m-0 justify-content-between">
						...
						<div class="col-12 col-md-3 ml-auto justify-content-end top-bar-right p-0">
							<ul>
								...
								<li><a href="{!! URL::to('profile') !!}">Welcome, {{Auth::guard('users')->user()->name}}</a></li>
								@else
			    ...
			    <div class="container">
					<div class="row m-0 justify-content-between">
					    <nav class="navbar navbar-expand-lg navbar-light col-12 p-0">
                             <a href="{!! URL::to('/') !!}" class="navbar-brand mr-3 mr-md-5">
        					    <img src="{{ asset('frontend/img/front_logo.png') }}" width="160px">
        				    </a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                ...
                                <li class="nav-item">
                                   <a class="nav-link" href="{!! URL::to('product-list/'.$n->id.'/'.$key) !!}">{{ $n->name }}</a>
                                ...
                                <span class="navbar-text desktop_view">
                                    <ul>
                                        <li>
            								<a href="{!! URL::to('view-cart') !!}" class="social-item position-relative">
            							...
            							<li>
            								<a href="{!! URL::to('profile') !!}" class="social-item">
