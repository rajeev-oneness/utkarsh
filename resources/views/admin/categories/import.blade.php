...
@section('content')
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.categories.importsave') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Categories</button>
                        <a class="btn btn-secondary" href="{{ route('admin.categories.index') }}"><i style="vertical-align: baseline;" class="fa fa-chevron-left"></i>Back</a>
                    </div>

                    <p><a href="{{ asset('/csv/category.csv') }}" target="_blank">Download Sample File Here</a></p>
