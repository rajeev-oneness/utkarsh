...
@section('content')
        ...
        <div class="app-title">
            <div class="active-wrap">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="button" id="btnSave"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Level3</button>
                    <a class="btn btn-secondary" href="{{ route('admin.level3.index') }}"><i style="vertical-align: baseline;" class="fa fa-chevron-left"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.level3.store') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
