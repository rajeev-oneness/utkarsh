                ...
                <form action="{{ route('admin.products.store') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    ...
                    <div class="tile-body form-body">
                        ...
                        <table class="table table-hover custom-data-table-style table-striped" id="">
                            <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute1 Name" name="attr1_name" id="attr1_name" value="{{ old('attr1_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute1 Value" name="attr1_value" id="attr1_value" value="{{ old('attr1_value') }}"/></td>
                            </tr>
                            <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute2 Name" name="attr2_name" id="attr2_name" value="{{ old('attr2_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute2 Value" name="attr2_value" id="attr2_value" value="{{ old('attr2_value') }}"/></td>
                            </tr>
                            <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute3 Name" name="attr3_name" id="attr3_name" value="{{ old('attr3_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute3 Value" name="attr3_value" id="attr3_value" value="{{ old('attr3_value') }}"/></td>
                            </tr>
                            <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute4 Name" name="attr4_name" id="attr4_name" value="{{ old('attr4_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute4 Value" name="attr4_value" id="attr4_value" value="{{ old('attr4_value') }}"/></td>
                            </tr>
                            <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute5 Name" name="attr5_name" id="attr5_name" value="{{ old('attr5_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute5 Value" name="attr5_value" id="attr5_value" value="{{ old('attr5_value') }}"/></td>
                            </tr>
                             <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute6 Name" name="attr6_name" id="attr6_name" value="{{ old('attr6_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute6 Value" name="attr6_value" id="attr6_value" value="{{ old('attr6_value') }}"/></td>
                            </tr>
                             <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute7 Name" name="attr7_name" id="attr7_name" value="{{ old('attr7_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute7 Value" name="attr7_value" id="attr7_value" value="{{ old('attr7_value') }}"/></td>
                            </tr>
                             <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute8 Name" name="attr8_name" id="attr8_name" value="{{ old('attr8_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute8 Value" name="attr8_value" id="attr8_value" value="{{ old('attr8_value') }}"/></td>
                            </tr>
                             <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute9 Name" name="attr9_name" id="attr9_name" value="{{ old('attr9_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute9 Value" name="attr9_value" id="attr9_value" value="{{ old('attr9_value') }}"/></td>
                            </tr>
                             <tr>
                                <td><input class="form-control" type="text" placeholder="Attribute10 Name" name="attr10_name" id="attr10_name" value="{{ old('attr10_name') }}"/></td>
                                <td><input class="form-control" type="text" placeholder="Attribute10 Value" name="attr10_value" id="attr10_value" value="{{ old('attr10_value') }}"/></td>
                            </tr>
                        </table>
