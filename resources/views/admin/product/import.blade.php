...
@section('content')
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.products.importsave') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
                    ...
                    <p><a href="{{ asset('/csv/test_csv.csv') }}" target="_blank">Download Sample File Here</a></p>
