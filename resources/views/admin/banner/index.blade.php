                        ...
                        <tbody>
                            ...
                            @foreach($banner as $key => $banner)
                                <tr>
                                    <td>{{ $slno }}</td>
                                    <td>{{ $banner->title }}</td>
                                    <td>{{ empty($banner->category->name)? ' ':$banner->category->name }}</td>
                                    <td>{{ $banner->link }}</td>
                                    <td>
                                        @if($banner->image!='')
                                        <img style="width: 150px;height: 100px; display: block !important;" src="{{URL::to('/').'/banners/'}}{{$banner->image}}">
                                        @endif
                                    </td>
                                    ...
                                    <div class="toggle-button-cover margin-auto">
                                        <div class="button-cover">
                                            <div class="button-togglr b2" id="button-11">
                                                <input id="toggle-block" type="checkbox" name="is_active" class="checkbox" data-banner_id="{{ $banner['id'] }}" {{ $banner['is_active'] == 1 ? 'checked' : '' }}>
