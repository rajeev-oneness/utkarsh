            ...
            <div class="tile">
                <form action="{{ route('admin.products.update') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    ...
                    <div class="tile-body form-body">
                        ...
                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="price">Price <span class="m-l-5 text-danger"> *</span></label>-->
                        <!--    <input class="form-control @error('usprice') is-invalid @enderror" type="text" name="usprice" id="usprice" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('usprice',$targetproduct->usprice) }}" required/>-->
                        ...
                        <!--    <input class="form-control @error('usoffered_price') is-invalid @enderror" type="text" name="usoffered_price" id="usoffered_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('usoffered_price',$targetproduct->usoffered_price) }}" required/>-->
                        <!--    @error('usoffered_price') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="uscurrency">Currency </label>-->
                        <!--    <input class="form-control @error('uscurrency') is-invalid @enderror" type="text" name="uscurrency" id="uscurrency" value="{{ old('uscurrency',$targetproduct->uscurrency) }}"/>-->
                        <!--    @error('uscurrency') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">
                        <!--    <label class="control-label" for="usshipping_charge">Shipping Charge </label>-->
                        <!--    <input class="form-control @error('usshipping_charge') is-invalid @enderror" type="text" name="usshipping_charge" id="usshipping_charge" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('usshipping_charge',$targetproduct->usshipping_charge) }}"/>-->
                        <!--    @error('usshipping_charge') {{ $message }} @enderror-->
                        <!--</div>-->-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="usmeta_title">Meta Title </label>-->
                        <!--    <input class="form-control @error('usmeta_title') is-invalid @enderror" type="text" name="usmeta_title" id="usmeta_title" value="{{ old('usmeta_title',$targetproduct->usmeta_title) }}"/>-->
                        <!--    @error('usmeta_title') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="usmeta_keywords">Meta Keywords </label>-->
                        <!--    <input class="form-control @error('usmeta_keywords') is-invalid @enderror" type="text" name="usmeta_keywords" id="usmeta_keywords" value="{{ old('usmeta_keywords',$targetproduct->usmeta_keywords) }}"/>-->
                        <!--    @error('usmeta_keywords') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="usimg_alt_tag">Img Alt Tag</label>-->
                        <!--    <input class="form-control @error('usimg_alt_tag') is-invalid @enderror" type="text" name="usimg_alt_tag" id="usimg_alt_tag" value="{{ old('usimg_alt_tag',$targetproduct->usimg_alt_tag) }}"/>-->
                        <!--    @error('usimg_alt_tag') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="usmeta_description">Meta description</label>-->
                        <!--    <textarea name="usmeta_description" id="usmeta_description" class="form-control ckeditor @error('usmeta_description') is-invalid @enderror" rows="8">{{$targetproduct->usmeta_description }}</textarea>-->
                        ...
                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="price">Price <span class="m-l-5 text-danger"> *</span></label>-->
                        <!--    <input class="form-control @error('ukprice') is-invalid @enderror" type="text" name="ukprice" id="ukprice" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('ukprice',$targetproduct->ukprice) }}" required/>-->
                        ...
                        <!--    <input class="form-control @error('ukoffered_price') is-invalid @enderror" type="text" name="ukoffered_price" id="ukoffered_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('ukoffered_price',$targetproduct->ukoffered_price) }}" required/>-->
                        <!--    @error('ukoffered_price') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="ukcurrency">Currency </label>-->
                        <!--    <input class="form-control @error('ukcurrency') is-invalid @enderror" type="text" name="ukcurrency" id="ukcurrency" value="{{ old('ukcurrency',$targetproduct->ukcurrency) }}"/>-->
                        ...
                        <!--    <input class="form-control @error('ukshipping_charge') is-invalid @enderror" type="text" name="ukshipping_charge" id="ukshipping_charge" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('ukshipping_charge',$targetproduct->ukshipping_charge) }}"/>-->
                        <!--    @error('ukshipping_charge') {{ $message }} @enderror-->
                        <!--</div>-->-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="ukmeta_title">Meta Title </label>-->
                        <!--    <input class="form-control @error('ukmeta_title') is-invalid @enderror" type="text" name="ukmeta_title" id="ukmeta_title" value="{{ old('ukmeta_title',$targetproduct->ukmeta_title) }}"/>-->
                        <!--    @error('ukmeta_title') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="ukmeta_keywords">Meta Keywords </label>-->
                        <!--    <input class="form-control @error('ukmeta_keywords') is-invalid @enderror" type="text" name="ukmeta_keywords" id="ukmeta_keywords" value="{{ old('ukmeta_keywords',$targetproduct->ukmeta_keywords) }}"/>-->
                        <!--    @error('ukmeta_keywords') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="ukimg_alt_tag">Img Alt Tag</label>-->
                        <!--    <input class="form-control @error('ukimg_alt_tag') is-invalid @enderror" type="text" name="ukimg_alt_tag" id="ukimg_alt_tag" value="{{ old('ukimg_alt_tag',$targetproduct->ukimg_alt_tag) }}"/>-->
                        <!--    @error('ukimg_alt_tag') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="ukmeta_description">Meta description</label>-->
                        <!--    <textarea name="ukmeta_description" id="ukmeta_description" class="form-control ckeditor @error('ukmeta_description') is-invalid @enderror" rows="8">{{ $targetproduct->ukmeta_description }}</textarea>-->
                        ...
                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="price">Price <span class="m-l-5 text-danger"> *</span></label>-->
                        <!--    <input class="form-control @error('rowprice') is-invalid @enderror" type="text" name="rowprice" id="rowprice" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('rowprice',$targetproduct->rowprice) }}" required/>-->
                        ...
                        <!--    <input class="form-control @error('rowoffered_price') is-invalid @enderror" type="text" name="rowoffered_price" id="rowoffered_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('rowoffered_price',$targetproduct->rowoffered_price) }}" required/>-->
                        <!--    @error('rowoffered_price') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="rowcurrency">Currency </label>-->
                        <!--    <input class="form-control @error('rowcurrency') is-invalid @enderror" type="text" name="rowcurrency" id="rowcurrency" value="{{ old('rowcurrency',$targetproduct->rowcurrency) }}"/>-->
                        ...
                        <!--    <input class="form-control @error('rowshipping_charge') is-invalid @enderror" type="text" name="rowshipping_charge" id="rowshipping_charge" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('rowshipping_charge',$targetproduct->rowshipping_charge) }}"/>-->
                        <!--    @error('rowshipping_charge') {{ $message }} @enderror-->
                        <!--</div>-->-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="rowmeta_title">Meta Title </label>-->
                        <!--    <input class="form-control @error('rowmeta_title') is-invalid @enderror" type="text" name="rowmeta_title" id="rowmeta_title" value="{{ old('rowmeta_title',$targetproduct->rowmeta_title) }}"/>-->
                        <!--    @error('rowmeta_title') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="rowmeta_keywords">Meta Keywords </label>-->
                        <!--    <input class="form-control @error('rowmeta_keywords') is-invalid @enderror" type="text" name="rowmeta_keywords" id="rowmeta_keywords" value="{{ old('rowmeta_keywords',$targetproduct->rowmeta_keywords) }}"/>-->
                        <!--    @error('rowmeta_keywords') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="rowimg_alt_tag">Img Alt Tag </label>-->
                        <!--    <input class="form-control @error('rowimg_alt_tag') is-invalid @enderror" type="text" name="rowimg_alt_tag" id="rowimg_alt_tag" value="{{ old('rowimg_alt_tag',$targetproduct->rowimg_alt_tag) }}"/>-->
                        <!--    @error('rowimg_alt_tag') {{ $message }} @enderror-->
                        <!--</div>-->

                        <!--<div class="form-group">-->
                        <!--    <label class="control-label" for="rowmeta_description">Meta description </label>-->
                        <!--    <textarea name="rowmeta_description" id="rowmeta_description" class="form-control ckeditor @error('rowmeta_description') is-invalid @enderror" rows="8">{{$targetproduct->rowmeta_description }}</textarea>-->
