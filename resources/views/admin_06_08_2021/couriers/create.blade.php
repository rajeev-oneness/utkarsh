    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="{{ route('admin.couriers.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name"> Courier Name <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name') }}" autocomplete="off"/>
                            @error('name') {{ $message ?? '' }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="weight"> Weight <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('weight') is-invalid @enderror" type="text" name="weight" id="weight" value="{{ old('weight') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('economy') is-invalid @enderror" type="text" name="economy" id="economy" value="{{ old('economy') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('express') is-invalid @enderror" type="text" name="express" id="express" value="{{ old('express') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off"/>
                            @error('express') {{ $message ?? '' }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="cod"> COD Charges <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('cod') is-invalid @enderror" type="text" name="cod" id="cod" value="{{ old('cod') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off"/>
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save courier</button>
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('admin.couriers.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
                </form>
