...
@section('content')
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.productstock.update') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
                    ...
                    <div class="tile-body form-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('product_id') is-invalid @enderror" name="product_id" id="product_id">
                                ...
                                <option value="{{ $n->id }}"@if($n->id== $targetProduct->product_id){{ 'selected' }} @endif>{{$n->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <!-- <div class="form-group">
                            ...
                            @foreach($sizes as $n)
                            <option value="{{ $n->id }}"@if($n->id == $targetProduct->size_id){{ 'selected' }} @endif>{{$n->sizes}}</option>
                            @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('current_stock') is-invalid @enderror" type="text" name="current_stock" id="current_stock" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ $targetProduct->current_stock }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('stock_alert') is-invalid @enderror" type="text" name="stock_alert" id="stock_alert" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ $targetProduct->stock_alert }}" />
